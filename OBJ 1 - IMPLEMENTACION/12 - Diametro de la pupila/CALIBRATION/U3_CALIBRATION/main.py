...
def fill_holes_in_video(video_path):
    ...
    kernel = np.ones((29, 29), np.uint8)  # Kernel de tamaño ajustable
...
# Uso de la función
original_video = "18-10-24_15-35-20_VIDEO_OJO_UX.avi"
...
# Uso de la función
video = detect_circles_and_overlay(video, original_video)
