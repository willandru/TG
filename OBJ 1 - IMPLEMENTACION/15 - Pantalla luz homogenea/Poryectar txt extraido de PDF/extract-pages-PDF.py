...
pagina_inicio = 78  # Cambia este valor al número de página inicial
pagina_fin = 110    # Cambia este valor al número de página final
...
with open('lectura.pdf', 'wb') as nuevo_pdf:
