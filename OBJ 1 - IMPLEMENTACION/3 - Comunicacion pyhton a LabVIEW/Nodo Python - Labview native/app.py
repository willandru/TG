...
def display_text():
    ...
    with open('C:/Users/willi/GITHUB/TG/OBJ 1 - IMPLEMENTACION/3 - Comunicacion pyhton a LabVIEW/Nodo Python - Labview native/texto_limpio.txt', 'r', encoding='utf-8') as file:
        text = file.read()
